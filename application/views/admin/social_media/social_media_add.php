    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('social_media_add_act') ?>" method="POST">
                        ...
                        <div class="input-group mb-3" style="width: 30%;float: left;margin-right: 3%">
                            ...
                            <input name="platform" type="text" class="form-control" aria-describedby="basic-addon1">
                        </div>
                        ...
                        <div class="input-group mb-3" style="width: 30%;float: left;margin-right: 3%">
                            ...
                            <input name="link" type="text" class="form-control" aria-describedby="basic-addon1">
                        </div>
                        ...
                        <div class="input-group mb-3" style="width: 30%;float: left;margin-right: 3%">
                            ...
                            <input name="icon" type="text" class="form-control" aria-describedby="basic-addon1">
                        </div>
